...
class Actor(nn.Module):
    def __init__(self, hidden_size, attn_size, actor_size=512):
        super(Actor, self).__init__()
        self.hidden_size = hidden_size
        self.attn_size = attn_size
        # self.attn_size = 128
        self.actor_size = actor_size
        self.gru = nn.GRU(hidden_size + attn_size, actor_size)
        self.fc = nn.Linear(actor_size, hidden_size)
        self.softmax = nn.LogSoftmax(dim=1)
    ...
    def forward(self, hidden, attn):
        ...
        inp = torch.cat((hidden, attn.transpose(1, 0)), 2)
...
class AttnDecoderRNN(nn.Module):
    def __init__(self, hidden_size, output_size, dropout_p=0.1, max_length=MAX_LENGTH):
        ...
        self.actor1 = Actor(self.hidden_size, self.hidden_size, self.hidden_size)
        self.actor2 = Actor(self.hidden_size, self.max_length, self.hidden_size)
    ...
    def forward(self, input, hidden, encoder_outputs):
        ...
        # pdb.set_trace()
        action, actor_hidden = self.actor1(hidden, output)
